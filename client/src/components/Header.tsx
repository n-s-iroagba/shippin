  ...
  return (
    <header className="relative bg-cover bg-center h-screen lg:h-[80vh] bg-image flex flex-col py-4">
      ...
      <div className="relative z-10 flex flex-col justify-between flex-grow text-center text-white">
        <div className="mt-8">
          <h1 className="text-4xl my-4 text-dark-blue">LEADER IN</h1>
          <h1 className="text-4xl font-bold mb-4 text-dark-blue">SHIPPING LOGISTICS</h1>
        </div>
        ...
        <div className="relative z-10 flex items-center justify-center mb-4">
          <form
            ...
            className="w-full max-w-lg bg-white bg-opacity-95 p-8 rounded-xl shadow-2xl border border-dark-blue/20 backdrop-blur-sm"
          >
            <div className="mb-4">
              <h2 className="text-dark-blue text-center">TRACK YOUR SHIPMENT</h2>
            </div>
            <div className="mb-4">
              <label
                htmlFor="booking-id"
              ...
              <input
                type="text"
                id="booking-id"
                className="mt-1 block w-full text-dark-blue rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"
